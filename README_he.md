...
מרבית יישומי ניהול המרפאות דורשים חיבור יציב לאינטרנט ושרתים בענן. זה לא תמיד זמין. הפסקות חשמל, הפרעות קישוריות ותקלות בתשתית קורות מדי יום, במיוחד במקומות , מרפאות כפריות וצוותי בריאות ניידים.
...
רשימת מרפאות קרובות עם הצעות על בסיס מרחק (אוטומטית באזור ישראל, רשימה מותאמת elsewhere). שם וקואורדינטות של המרפאה ניתנים לעריכה מהפרופיל.
